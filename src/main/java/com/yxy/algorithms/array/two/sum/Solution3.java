...
public class Solution3 {
    ...
    /**
     * Approach 3: One-pass Hash Table It turns out we can do it in one-pass. While we iterate and inserting elements
     * into the table, we also look back to check if current element's complement already exists in the table. If it
     * exists, we have found a solution and return immediately.
     * 
     * Runtime: 3 ms, faster than 64.62% of Java online submissions for Two Sum.
     * 
